            ...
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <!-- error -->
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des">
                                    <p>Access the DashLite panel using your new passcode.</p>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
                        <?= form_open() ?>
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-lg" name="password" id="default-01" placeholder="Enter your password">
                            </div><!-- .foem-group -->
                            <div class="form-group">
                                <div class="form-label-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="password" class="form-control form-control-lg" name="confirmPass" id="password" placeholder="Confirm your password">
                                </div>
                            </div><!-- .foem-group -->
                            <div class="form-group">
                        ...
                        <?= form_close() ?>
                    <?php endif ?>
                    <div class="form-note-s2 pt-4"> Already have an Account? <a href="<?= base_url('user/auth')?>">Login</a>
                    </div>
