                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <?php if( $current_user->badge == 'Unverified'): ?>
                                                    <div class="user-status user-status-unverified"><?= $current_user->badge ?></div>
                                                    <?php else: ?>
                                                    <div class="user-status user-status-verified"><?= $current_user->badge ?></div>
                                                    <?php endif ?>
